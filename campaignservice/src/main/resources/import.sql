insert into Campaign (id, iban, accountname, nameofbank, donationminimum,name,targetamount) VALUES (1,'DE44123456780100200300','Max Mustermann','ABC Bank',25,'Trikots für A-Jugend', 1000.0);
insert into Campaign (id, iban, accountname, nameofbank, donationminimum,name,targetamount) VALUES (2,'DE44123456780100200300','Max Mustermann','ABC Bank',25,'Rollstuhl für Maria', 2500.0);
